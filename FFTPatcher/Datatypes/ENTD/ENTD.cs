...
namespace FFTPatcher.Datatypes
{
    ...
    public class AllENTDs : PatchableFile, IXmlDigest
    {
        ...
        public override IList<PatchedByteArray> GetPatches( Context context )
        {
            ...
            {
                result.Add( new PatchedByteArray( PatcherLib.Iso.PsxIso.BATTLE.ENTD1_ENT, 0x00, bytes1 ) );
                result.Add( new PatchedByteArray( PatcherLib.Iso.PsxIso.BATTLE.ENTD2_ENT, 0x00, bytes2 ) );
                result.Add( new PatchedByteArray( PatcherLib.Iso.PsxIso.BATTLE.ENTD3_ENT, 0x00, bytes3 ) );
                result.Add( new PatchedByteArray( PatcherLib.Iso.PsxIso.BATTLE.ENTD4_ENT, 0x00, bytes4 ) );
            }
            else if ( context == Context.US_PSP )
            {
                result.Add( new PatchedByteArray( PatcherLib.Iso.FFTPack.BATTLE.ENTD1_ENT, 0x00, bytes1 ) );
                result.Add( new PatchedByteArray( PatcherLib.Iso.FFTPack.BATTLE.ENTD2_ENT, 0x00, bytes2 ) );
                result.Add( new PatchedByteArray( PatcherLib.Iso.FFTPack.BATTLE.ENTD3_ENT, 0x00, bytes3 ) );
                result.Add( new PatchedByteArray( PatcherLib.Iso.FFTPack.BATTLE.ENTD4_ENT, 0x00, bytes4 ) );
                result.Add( new PatchedByteArray( PatcherLib.Iso.FFTPack.BATTLE.ENTD5_ENT, 0x00, PSPEventsToByteArray() ) );
            }
