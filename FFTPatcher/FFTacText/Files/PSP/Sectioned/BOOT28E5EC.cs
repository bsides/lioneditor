        ...
        public override IDictionary<Enum, long> Locations
        {
            get
            {
                if( locations == null )
                {
                    ...
                    locations.Add( PspIso.Files.PSP_GAME.SYSDIR.BOOT_BIN, 0x28E5EC );
                    locations.Add( PspIso.Files.PSP_GAME.SYSDIR.BOOT_BIN, 0x30A198 );
                    locations.Add( PspIso.Files.PSP_GAME.SYSDIR.EBOOT_BIN, 0x28E5EC );
                    locations.Add( PspIso.Files.PSP_GAME.SYSDIR.EBOOT_BIN, 0x30A198 );
                }
                return locations;
            }
        }
