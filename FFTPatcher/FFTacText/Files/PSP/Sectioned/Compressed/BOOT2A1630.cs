...
{
    /// <summary>
    /// Text for the BOOT.BIN file at location 0x2A1630.
    /// </summary>
    public class BOOT2A1630 : BasePSPCompressedFile, IBootBin
    {
        ...
        public override IDictionary<Enum, long> Locations
        {
            get
            {
                if( locations == null )
                {
                    ...
                    locations.Add( PspIso.Files.PSP_GAME.SYSDIR.BOOT_BIN, 0x2A1630 );
                    locations.Add( PspIso.Files.PSP_GAME.SYSDIR.EBOOT_BIN, 0x2A1630 );
                }
                return locations;
            }
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BOOT2A1630"/> class.
        /// </summary>
        ...
        public override IList<NamedSection> GetNamedSections()
        {
            ...
            result.Add( new NamedSection( this, SectionType.AbilityDescriptions, 15, true, 512 ) );
