...
{
    public class SAMPLELZW : IStringSectioned
    {
        ...
        public int MaxLength { get { return 0x4B88; } }
        public int Length { get { return ToBytes().Count; } }

        static SAMPLELZW()
        {
            Instance = new SAMPLELZW( Properties.Resources.WORLD_LZW );
        ...
        {
            Sections = new List<IList<string>>( 24 );
            for( int i = 0; i < 24; i++ )
            {
        ...
        {
            List<List<byte>> byteSections = new List<List<byte>>( 24 );
