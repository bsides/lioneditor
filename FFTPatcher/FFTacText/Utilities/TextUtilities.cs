...
namespace FFTPatcher.TextEditor
{
    ...
    public static class TextUtilities
    {
        ...
        {
            Dictionary<int, string[]> offsets = new Dictionary<int, string[]>();
            offsets[0xd200] = new string[0xd0] {
            ...
            offsets[0xd300] = new string[0xd0] {
            ...
            offsets[0xd400] = new string[0xd0] {
            ...
            offsets[0xd500] = new string[0xd0] {
            ...
            offsets[0xd600] = new string[0xd0] {
            ...
            offsets[0xd700] = new string[0xd0] {
            ...
            offsets[0xd800] = new string[0xd0] {
            ...
            offsets[0xd900] = new string[0xb5] {
            ...
            offsets[0xda0d] = new string[103] {
                ...
                "醒","譚","裸","傀","儡","詔","勅","滞","搾","症","睛","旦","忙","眷","抹","幣",
                "潔","忽","厭","惹" };
            foreach ( KeyValuePair<int, string[]> kvp in offsets )
            {
                string[] kanji = kvp.Value;
                int offset = kvp.Key;
                for ( int i = 0; i < kanji.Length; i++ )
                {
                    PSXMap[offset + i] = kanji[i];
                }
            }
}
