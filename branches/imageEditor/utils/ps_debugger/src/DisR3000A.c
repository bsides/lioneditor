...
#define dOfB()		sprintf(ostr, "%s %4.4lx (%8.8lx (%s)) [%8.8lx]", ostr, _Im_, psxRegs.GPR.r[_Rs_], disRNameGPR[_Rs_], AGEMO_CALC_ADDR(psxRegs.GPR.r[_Rs_], _Im_))
