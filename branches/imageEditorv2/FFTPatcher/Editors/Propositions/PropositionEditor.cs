...
namespace FFTPatcher.Editors
{
    public partial class PropositionEditor : BaseEditor
    {
        ...
        public void BindTo( Proposition prop, IList<UInt16> prices )
        {
            ...
            price1ComboBox.SetIndexAndDefault( prop.PriceIndex1, prop.Default.PriceIndex1 );
            price2ComboBox.SetIndexAndDefault( prop.PriceIndex2, prop.Default.PriceIndex2 );
            rewardComboBox.SetIndexAndDefault( (int)prop.Reward, (int)prop.Default.Reward );
        ...
        public void NotifyNewPrices( IList<UInt16> prices )
        {
        ...
        private void priceComboBox_SelectedIndexChanged( object sender, EventArgs e )
        {
            if (!ignoreChanges)
            {
                ...
                PatcherLib.ReflectionHelpers.SetFieldOrProperty( proposition, (string)box.Tag, (byte)box.SelectedIndex );
                FireDataChanged();
            }
        }
