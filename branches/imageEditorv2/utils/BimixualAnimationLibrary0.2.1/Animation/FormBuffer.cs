...
namespace Animation
{
    ...
    public class FormBuffer
    {
        ...
        protected Form form; // the screen to which we are applying the buffer
        ...
        public FormBuffer(Form p_form)
        {
            form = p_form;
            SetBuffer(); // setup
            curGraphicsObject = Graphics.FromHwnd(form.Handle); // set the default Graphics object
        }
        ...
        protected void SetBuffer()
        {
            ...
            bufferContext.MaximumBuffer = new Size(form.Width + 1, form.Height + 1);

            // Allocates a graphics buffer the size of this form
            // using the pixel format of the Graphics created by 
            // the Form.CreateGraphics() method, which returns a 
            // Graphics object that matches the pixel format of the form.
            bufferG = bufferContext.Allocate(form.CreateGraphics(),
        ...
        {
            curGraphicsObject = Graphics.FromHwnd(form.Handle);
        }
    }
}
