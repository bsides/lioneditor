...
{
    /// <summary>
    /// Text for the BOOT.BIN file at location 0x299024.
    /// </summary>
    public class BOOT299024 : AbstractBootBinFile
    {
        ...
        public override IDictionary<Enum, long> Locations
        {
            get
            {
                if( locations == null )
                {
                    ...
                    locations.Add( PspIso.Files.PSP_GAME.SYSDIR.BOOT_BIN, 0x299024 );
                    locations.Add( PspIso.Files.PSP_GAME.SYSDIR.EBOOT_BIN, 0x299024 );
                }
                return locations;
            }
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BOOT299024"/> class.
        /// </summary>
        ...
        public override IList<NamedSection> GetNamedSections()
        {
            ...
            result.Add( new NamedSection( this, SectionType.JobNames, 4 ) );
            return result;
        }
