...
{
    /// <summary>
    /// Represents the text in the JOBSTTS.OUT file.
    /// </summary>
    public class JOBSTTSOUT : BasePSXCompressedFile
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JOBSTTSOUT"/> class.
        /// </summary>
        ...
        public override IDictionary<int, long> Locations
        {
            get
            {
                if( locations == null )
                {
                    ...
                    locations.Add( (int)PsxIso.EVENT.JOBSTTS_OUT, 0x6508 );
                }
        ...
        public override IList<NamedSection> GetNamedSections()
        {
            ...
            result.Add( new NamedSection( this, SectionType.JobDescriptions, 12, true, 160 ) );
