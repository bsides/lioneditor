...
namespace FFTPatcher.Datatypes
{
    ...
    public class AllSkillSets : PatchableFile, IXmlDigest
    {
        ...
        public override IList<PatchedByteArray> GetPatches( Context context )
        {
            ...
            {
                result.Add( new PatchedByteArray( PatcherLib.Iso.PsxIso.SCUS_942_21, 0x55294, bytes ) );
            }
            else if ( context == Context.US_PSP )
            {
                result.Add( new PatchedByteArray( PatcherLib.Iso.PspIso.Files.PSP_GAME.SYSDIR.BOOT_BIN, 0x275A38, bytes ) );
                result.Add( new PatchedByteArray( PatcherLib.Iso.PspIso.Files.PSP_GAME.SYSDIR.EBOOT_BIN, 0x275A38, bytes ) );
            }
