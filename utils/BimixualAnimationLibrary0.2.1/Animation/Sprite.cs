...
namespace Animation
{
    ...
    public abstract class Sprite
    {
        ...
        private List<AlterationInterface> alterations = new List<AlterationInterface>(5);
        ...
        public void AddAlteration(AlterationInterface p_aao)
        {
        ...
        public virtual void DrawFilteredImage(Graphics p_g, Point p_point)
        {
            if (alterations.Count > 0)
            {
                ...
                foreach (AlterationInterface ai in alterations)
                {
