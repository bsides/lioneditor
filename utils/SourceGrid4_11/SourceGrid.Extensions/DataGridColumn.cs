...
namespace SourceGrid
{
    ...
    public class DataGridColumn : ColumnInfo
    {
        ...
        private List<Conditions.ICondition> mConditions = new List<SourceGrid.Conditions.ICondition>();
        /// <summary>
        ...
        private Dictionary<Conditions.ICondition, Cells.ICellVirtual> mConditionalCells = new Dictionary<SourceGrid.Conditions.ICondition, SourceGrid.Cells.ICellVirtual>();
